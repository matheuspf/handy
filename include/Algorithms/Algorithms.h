...
NO_RETURN(rotate, SINGLE_CONTAINER_DECLARATION_N,
          ::std::rotate(::std::begin(CONTAINER_1), ::std::begin(CONTAINER_1) + n, ::std::end(CONTAINER_1)); return CONTAINER_1;)

NO_RETURN(rotate_copy, DOUBLE_CONTAINER_DECLARATION_N,
...
NO_RETURN(sort, SINGLE_CONTAINER_DECLARATION, SINGLE_CONTAINER_APPLY)

NO_RETURN(partial_sort, SINGLE_CONTAINER_DECLARATION_N,
          ::std::partial_sort(::std::begin(CONTAINER_1), ::std::begin(CONTAINER_1) + n, ::std::end(CONTAINER_1));
          return CONTAINER_1;)

NO_RETURN(partial_sort_copy, DOUBLE_CONTAINER_DECLARATION_N,
          ::std::partial_sort_copy(::std::begin(CONTAINER_1), ::std::begin(CONTAINER_1),
                                   ::std::begin(CONTAINER_2), ::std::end(CONTAINER_2), FUNC_VAR_ARGS);
          return CONTAINER_1;)

NO_RETURN(stable_sort, SINGLE_CONTAINER_DECLARATION, SINGLE_CONTAINER_APPLY)

NO_RETURN(nth_element, SINGLE_CONTAINER_DECLARATION_N,
...
NO_RETURN(inplace_merge, SINGLE_CONTAINER_DECLARATION_N,
